...
var condition="";//查询条件
var createtime = "";//查询起始时间
var createtime2 = "";//查询结束时间
$(function() {
	//修改和删除按钮禁用
...
function Search_Btn(){
	...
	if(createtime1!=""&&createtime2!=""){
		condition+=" G.CREATEDATE between TO_DATE('"+createtime1+"','YYYY\"年\"MM\"月\"dd\"日\" HH24:MI:SS') and TO_DATE('"+
		createtime2+"','YYYY\"年\"MM\"月\"dd\"日\" HH24:MI:SS') AND ";
	}
